package com.nhungptp.dataproviders;

import com.nhungptp.helpers.ExcelHelper;
import com.nhungptp.helpers.SystemHelper;
...
public class DataProviderFactory {
    ...
    public Object[][] dataLoginFromExcel() {
        ...
        Object[][] data = excelHelper.getExcelData(SystemHelper.getCurrentDir() + "src/test/resources/testdata/AccountLogin.xlsx", "LoginSuccess");
    ...
    public Object[][] dataLoginFromExcelMultiRow() {
        ExcelHelper excelHelper = new ExcelHelper();
        Object[][] data = excelHelper.getDataHashTable(SystemHelper.getCurrentDir() + "src/test/resources/testdata/AccountLogin.xlsx", "LoginSuccess", 5, 7);
